...
public class SnakeHead : MonoBehaviour
{
    ...
    [SerializeField] private float _tailDistance = 1.3f;
    ...
    private WaitForSeconds _waitForStep;
    ...
    {
        float stepDelay = _moveStepSize / _currentMoveSpeed;
        _waitForStep = new WaitForSeconds(stepDelay);
    }
    ...
    public float GetBaseSpeed() => _moveSpeed;
